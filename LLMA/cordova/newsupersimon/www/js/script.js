...
function finJuego(){ //Se ejecuta cuando el jugador se equivoca
...
function turnoSimon() { //Funcion que añade una nueva interaccion
	Jugador = [];
	turnoJugador = false;
	addTile();
	reproducir();
...
function clickHandler(tile) { //Sirve para 
	if (turnoJugador) {
		Jugador.push(tile);
		playSound(tile);
